...
{
	Super::BeginPlay();
    CurrentPiece->ScorePuntos = 0;
    GetWorldTimerManager().SetTimer(Score, this, &ABoard::MostrarScore, 10.0, true);
...
void ABoard::MostrarScore()
{
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, FString::Printf(TEXT("El Score De Puntos: %d"), CurrentPiece->ScorePuntos));
}
